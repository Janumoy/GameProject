    ...
    fixed at parallax_layer(0.2, 100) xoffset 100 yoffset 370:
        ...
        vbox:
            ...
            textbutton _("Загрузить"):
                action Show("action_overlay",
                    next_action=ShowMenu("load"),
                    anim_img="anim_load_frames",
                    duration=0.6     
            )

            textbutton _("Настройки"):
                action Show("action_overlay",
                    next_action=ShowMenu("preferences"),
                    anim_img="anim_settings_frames",
                    duration=0.6
            )
            ...
            textbutton _("Об игре"):
                action Show("action_overlay",
                    next_action=ShowMenu("about"),
                    anim_img="anim_about_frames",
                    duration=0.6
            )

            textbutton _("Помощь"):
                action Show("action_overlay",
                    next_action=ShowMenu("help"),   
                    anim_img="anim_help_frames",
                    duration=0.6
            )
